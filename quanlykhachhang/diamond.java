...
public class diamond extends customer{
    
    public diamond(){
        super();
        loaikhachhang = "diamond";
    }
    public diamond(String makhachhang, String name, String diachi, String sodienthoai){
        super(makhachhang ,name, diachi, sodienthoai, "diamond");
    }
